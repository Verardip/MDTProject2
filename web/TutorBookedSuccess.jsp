...
<html>
    ...
    <body>
        ...
        <p>
            ...
            %>
            <%= studentName %>, you are all set for your tutoring session in <span class="className"><%= className %></span> with <span class="className"><%= tutorName %></span> on <u><%= tutorTime %></u>!
        </p>
        </div>
    </body>
</html>
